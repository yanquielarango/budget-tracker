    ...
    return (
        <SafeAreaView className="flex-1" >
                    ...
                    <VStack className=" justify-center items-center ">
                        {selectedImage ? (
                                ...
                                <Avatar className="bg-primary-500" size="3xl">
                                    ...
                                    <View   className="absolute right-0 bottom-1">
                                        <AvatarBadge className="justify-center items-center bg-[#673ab7]" >
                                            <Ionicons name="chevron-back" className="h-7 w-7 text-white "/>
                                        </AvatarBadge>
                                    </View>
                                </Avatar>
                            </TouchableOpacity>
                            ...
                            <Avatar className="bg-primary-500" size="3xl" >
                                ...
                                <View className="absolute right-0 bottom-1 " >
                                    <AvatarBadge className="justify-center items-center bg-[#673ab7]">
                                        <FontAwesome as="pencil" className="h-7 w-7 text-white "/>
                                    </AvatarBadge>
                                </View>
                            </Avatar>
                            </TouchableOpacity>
            ...
            <VStack className="bg-white border-t-[#e0e0e0] border-t-[1px] px-4 py-3  absolute bottom-0 right-0 left-0">
                <TouchableOpacity className="bg-[#673ab7] p-4 rounded-xl"  onPress={handleUpdateUserProfile}>
                    {isLoading ? (
